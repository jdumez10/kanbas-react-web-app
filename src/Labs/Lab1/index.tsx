...
export default function Lab1() { 
    return ( 
            <div id="wd-lab1"> 
                ...
                <div id="wd-lists"> 
                    ...
                    My favorite recipe: 
                        <ol id="wd-your-favorite-recipe"> 
                            <li>Combine pre-cooked cornmeal, salt, and warm water.</li> 
                            <li>Knead to form a smooth dough.</li>
                            <li>Shape the dough into balls, then flatten into disks.</li>
                            <li>Heat a skillet over medium heat and cook arepas until golden and crusty.</li>
                            <li>Serve the arepas warm.</li>
                        </ol> 
                ...
                Please 
                <a href="https://www.lipsum.cm"> click here </a> 
                to access my code repository on GitHub<br/>
            </div> 
        ); 
    } 